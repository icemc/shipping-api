...
object Dependencies {
  ...
  private object Versions {
    ...
    val zioSchemaProtobuf       = "0.4.2"
    val zioRedis                = "0.0.0+449-b7621f14-SNAPSHOT"
    val logback                 = "1.4.5"
  ...
  object Libraries {
    ...
    val tapir = Seq(
      ...
      "com.softwaremill.sttp.client3" %% "zio"                     % Versions.zioSttp
    )
    ...
    val akka = Seq( // Use this only if there is no other option

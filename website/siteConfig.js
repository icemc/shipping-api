...
const siteConfig = {
  title: 'zio-microservice', //You application name goes here
  tagline: 'TODO: Tagline',
  url: 'https://internal.hiis.io',
  baseUrl: '/zio-microservice/',

  projectName: 'zio-microservice',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Hiis.io`,
  ...
  customDocsPath: 'zio-microservice-seed-docs/target/mdoc',
